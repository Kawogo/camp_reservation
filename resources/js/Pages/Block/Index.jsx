...
const Index = ({ auth, blocks, flash }) => {
    ...
    return (
        <MainLayout user={auth.user} pageTitle={"Blocks"}>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 flex items-center justify-end">
                                                <button
                                                    id={`${block.id}-dropdown-button`}
                                                    data-dropdown-toggle={`table-dropdown-${block.id}`}
                                                ...
                                                >
                                                    <ul
                                                        ...
                                                        aria-labelledby={`${block.id}-dropdown-button`}
                                                    >
                                                        <li>
                                                            <Link
                                                                href={route(
                                                                ...
                                                                className="block py-2 px-4 hover:bg-gray-100 text-sm text-green-700  dark:hover:bg-green-600 dark:hover:text-white"
                                                            >
                                                                Show
                                                            </Link>
                                                        </li>
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                    ...
                                    <p class="mb-4 text-gray-500 dark:text-gray-300">
                                        ...
                                        related to this block on the system.
                                    </p>
