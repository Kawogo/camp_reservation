...
const EditCheckin = ({ auth, response }) => {
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        member_id: response.checkin.member_id,
        room_id: response.checkin.room_id,
    });
    ...
    function submit(e) {
        e.preventDefault();
        put(route("checkins.update", { checkin: response.checkin }));
    }

    return (
        <MainLayout user={auth.user} pageTitle={"Edit Checkin"}>
            <div className="mb-5">
                <Link
