...
const Index = ({ auth, sections, flash }) => {
    const [section, setSection] = useState(null);

    // CRUD
    const deleteSection = () => {
        router.delete(route("sections.destroy", section));
    };

    return (
        <MainLayout user={auth.user} pageTitle={"Department Sections"}>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 flex items-center justify-end">
                                                <button
                                                    id={`${section.id}-dropdown-button`}
                                                    data-dropdown-toggle={`table-dropdown-${section.id}`}
                                                ...
                                                <div
                                                    id={`table-dropdown-${section.id}`}
                                                    className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                                                >
                                                    <ul
                                                        className="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                        aria-labelledby={`${section.id}-dropdown-button`}
                                                    >
                                                        <li>
                                                            <Link
                                                                href={route(
